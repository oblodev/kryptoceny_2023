  ...
  return (
    <>
      <Head>
        <title>{`Kurs ${
          krypto.name
        } (${krypto.symbol.toUpperCase()}) - Dane, Statystyki, Historia`}</title>
        <meta
          name="description"
          content={`Sprawdź aktualny kurs, zmiany cenowe, kapitalizację rynkową oraz inne informacje o kryptowalucie ${krypto.name}. Dowiedz się więcej o jej historii oraz bieżących notowaniach.`}
        />
        <meta
          property="og:title"
          content={`Kurs ${krypto.name} - Aktualne Dane`}
        />
        <meta
          property="og:description"
          content={`Aktualne informacje i analiza ${krypto.name}.`}
        />
        <meta property="og:type" content="article" />
        <meta
          property="og:url"
          content={`https://kryptoceny.pl/kryptowaluta/${krypto.symbol}`}
        />
        <meta property="og:image" content={krypto.image.large} />
        <link
          rel="canonical"
          href={`https://kryptoceny.pl/kryptowaluta/${krypto.symbol}`}
        />
      </Head>
      <div className={styles.wrapper}>
        <div className={styles.header}>
          <h1>
            Kurs {krypto.name} ({krypto.symbol.toUpperCase()}) - Pełne
            Informacje i Dane Rynkowe
          </h1>
        </div>
        ...
        <div className={styles.kryptoWrap}>
          ...
          <div className={styles.kryptoFakty}>
            <p>
              ...
              {krypto.market_data.current_price.usd.toFixed(2)}. Kurs
              kryptowaluty {krypto.name}{" "}
              {krypto.market_data.price_change_percentage_24h > 0
                ? "zyskał"
                : "stracił"}{" "}
              w ostatnich 24h{" "}
            ...
            <div className={styles.kryptoInfo}>
              ...
              <div className={styles.kryptoInfoCard}>
                ...
                <p>
                  {krypto.market_data.total_supply}{" "}
                  {krypto.symbol.toUpperCase()}
                </p>
              </div>
            </div>
        ...
        <div className={styles.kryptoButtons}>
          <Link href="/kurskryptowalut">
            <button className={styles.wroc}>Wróć do listy kryptowalut</button>
          </Link>
        </div>
      </div>
    </>
